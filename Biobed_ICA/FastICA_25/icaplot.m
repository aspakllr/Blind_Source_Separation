...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
 ...
 case {'', 'classic', 'dispsig'} 
  ...
  for i = 1:numSignals
    ...
    % Dikos mou epipleon kwdikas gia ta xrwmata
    %**********************************************************************************************
    if i==1, h=plot(xrange, s1(n1(1), range));  set(h,'color',[0.502 0.502 1]);xlim([0 61980]);end
    if i==2,  h2=plot(xrange, s1(n1(2), range));  set(h2,'color',[0.502 0 0]);xlim([0 61980]);end
    if i==3, h3=plot(xrange, s1(n1(3), range));  set(h3,'color', [0.85 0.7 1]);xlim([0 61980]);end
    if i==4, h4=plot(xrange, s1(n1(4), range));  set(h4,'color', [0.204 0 0]);xlim([0 61980]);end    
    %**********************************************************************************************   
  end
