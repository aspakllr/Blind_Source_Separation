...
%pow3
[icasig_pow3s] = fastica (filt_sig_low,'approach','symm','g','pow3','numofIC',2);
[icasigd_pow3d] = fastica (filt_sig_low,'approach','defl','g','pow3','numofIC',2);
...
print(p1_pow3s,'C:\Users\Schnitzel\Desktop\thesis\images\ica\filtra\low\per1\p1_pow3s','-dpdf','-r0')
...
print(p1_pow3d,'C:\Users\Schnitzel\Desktop\thesis\images\ica\filtra\low\per1\p1_pow3d','-dpdf','-r0')

%tanh
[icasig_tanhs] = fastica (filt_sig_low,'approach','symm','g','tanh','numofIC',2);
[icasigd_tanhd] = fastica (filt_sig_low,'approach','defl','g','tanh','numofIC',2);
...
print(p1_tanhs,'C:\Users\Schnitzel\Desktop\thesis\images\ica\filtra\low\per1\p1_tanhs','-dpdf','-r0')
...
print(p1_tanhd,'C:\Users\Schnitzel\Desktop\thesis\images\ica\filtra\low\per1\p1_tanhd','-dpdf','-r0')

%gauss
[icasig_gausss] = fastica (filt_sig_low,'approach','symm','g','gauss','numofIC',2);
[icasigd_gaussd] = fastica (filt_sig_low,'approach','defl','g','gauss','numofIC',2);
...
print(p1_gausss,'C:\Users\Schnitzel\Desktop\thesis\images\ica\filtra\low\per1\p1_gausss','-dpdf','-r0')
...
print(p1_gaussd,'C:\Users\Schnitzel\Desktop\thesis\images\ica\filtra\low\per1\p1_gaussd','-dpdf','-r0')

%skew
[icasig_skews] = fastica (filt_sig_low,'approach','symm','g','skew','numofIC',2);
[icasigd_skewd] = fastica (filt_sig_low,'approach','defl','g','skew','numofIC',2);
...
print(p1_skews,'C:\Users\Schnitzel\Desktop\thesis\images\ica\filtra\low\per1\p1_skews','-dpdf','-r0')
...
print(p1_skewd,'C:\Users\Schnitzel\Desktop\thesis\images\ica\filtra\low\per1\p1_skewd','-dpdf','-r0')
